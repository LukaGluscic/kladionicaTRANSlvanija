...
int main()
{
    ...
    while (1) {
        ...
        {
            double ulog2;
            cout << "Unesite iznos koji želite uložiti na utrke èetveronožnih trkaèa: " << endl;
            cin >> ulog2;
            if (ulog2 <= 0)
            {
                cout << "Pogrešan unos, iznos uloga mora biti veæi od 0." << endl;
                return 0;
            }
            // Ovdje dodajte logiku za utrke èetveronožnih trkaèa
        }
        if (izbor == 7)
        {
            break;
